...
import static cn.zbf.rabbitmq.config.RabbitConfig.ROUTINGKEY_A;
...
public class MsgProducer implements RabbitTemplate.ConfirmCallback {
    ...
    public void sendMsg(String content) {
        ...
        rabbitTemplate.convertAndSend(RabbitConfig.EXCHANGE_A, ROUTINGKEY_A, content, correlationId);
    }
